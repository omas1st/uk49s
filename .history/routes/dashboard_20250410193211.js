...
// Middleware: ensure that the user is authenticated (non-admin)
...
router.get('/', ensureAuthenticated, (req, res) => {
  ...
  // Retrieve up-to-date user info from the DB
...
// Message section: user sends a message to admin's Gmail address
